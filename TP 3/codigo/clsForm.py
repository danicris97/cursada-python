...
class clsForm(QtWidgets.QMainWindow):
	def __init__(self, sl=None, sw=None, pl=None, pw=None, variety=None,table=None):
		super(clsForm, self).__init__()
		uic.loadUi('TP 3/codigo/csvForm.ui',self)
		self.table=table
	...
	def recuperaDatos(self):
		datos=[self.sl,self.sw,self.pl,self.pw,self.variety]
